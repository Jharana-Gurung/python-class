# Personal Details
# Write a function print_details that takes three parameters: name, age, and city, and
# prints them in the format "Name: [name], Age: [age], City: [city]". Call this function
